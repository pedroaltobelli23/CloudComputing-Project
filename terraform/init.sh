...
if [ "$confirmation" == "yes" ]; then
    ...
    sleep 3
    terraform apply -var="database_username=$database_username" -var="database_password=$database_password" -var="key_pair_name=$key_pair_name" -var="database_name=$database_name" -var="bucket_name=$bucket_name"
else
    echo "Action aborted."
fi
